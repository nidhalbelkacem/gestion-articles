...
<div class="page-header">
    ...
    <h1 class="mt-2"><i class="bi bi-pencil-square me-2"></i>Modifier l'auteur</h1>
</div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('auteurs.update', $auteur) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nom" class="form-control form-control-lg @error('nom') is-invalid @enderror" value="{{ old('nom', $auteur->nom) }}">
